...
class DistroPatchMatch:
    def __init__(self, author_confidence, subject_confidence, description_confidence, filename_confidence, confidence, upstream_patch):
        ...
        self.upstream_patch = upstream patch
